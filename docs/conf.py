...
copyright = u'2010-2011, Ali Afshar, Florian Demmer'
...
# documentation.
html_theme_options = {
    'index_logo':       'flask-principal.png',
    'github_fork':      'fdemmer/flask-principal'
}
...
latex_documents = [
  ('index', 'FlaskPrincipal.tex', u'Flask Principal Documentation',
   u'Ali Afshar, Florian Demmer', 'manual'),
]
...
man_pages = [
    ('index', 'flaskprincipal', u'Flask Principal Documentation',
     [u'Ali Afshar, Florian Demmer'], 1)
]
